...
class _SignUpScreenState extends State<SignUpScreen>
  ...
  Widget _signUpAvatar() {
    ...
    const cameraIconSize = 40.0;
    const cameraIconSpacing = 15.0;
          ...
          child: SizedBox(
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(width: 0, color: clr.passive),
  ...
  Widget _phoneFormField() {
    return TextFormField(
      ...
      keyboardType: TextInputType.text,
      textInputAction: TextInputAction.next,
      onEditingComplete: () => _portfolioFocusNode.requestFocus(),
      decoration: InputDecoration(
  ...
  Widget _portfolioFormField() {
    return TextFormField(
      ...
      onEditingComplete: () => _specializationFocusNode.requestFocus(),
      decoration: InputDecoration(
        labelText: 'Portfolio',
        labelStyle: txt.labelDark,
        floatingLabelBehavior: FloatingLabelBehavior.auto,
  ...
  Widget _specializationFormField() {
    return TextFormField(
      enabled: true,
      ...
      keyboardType: TextInputType.text,
      textInputAction: TextInputAction.done,
      onEditingComplete: () => _specializationFocusNode.unfocus(),
      decoration: InputDecoration(
